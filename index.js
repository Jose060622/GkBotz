...
き⃟👤 *_Id: ${serialUser}_*
き⃟💀 *_Hora: ${time}_*
き⃟📍 *_Nombre: ${pushname}_*
き⃟🌿 *_Link: wa.me/${sender.split('@')[0]}_*
`
veri = sender
if (isGroup) {
...
switch (commandstik) {
case "E2J9Vq5U2WkZhMilaNIl0gxaBNgyCRclTdM21/k0d3c=":
let timestamp = speed()
let latensii = speed() - timestamp
const hfg = tobi.prepareMessageFromContent(from, {
"listMessage":  {
"title": `Hola ${pushname} 👋`,
"description": `👾 Nombre Del Bot : *${NomeDoBot}*
🛠️ Prefix : *Multi*
🌀 Velocidad : *${latensii.toFixed(4)} Segundos*
⚡ Libreria : *Baileys*
❄️ Lenguaje : *JavaScript*
...
tobi.relayWAMessage(hfg, {waitForAck: true, quoted: ftoko})
}
...
│
└───[🔍]————`
tobi.sendMessage(from, menu5, MessageType.text, {quoted: ftoko})
break
...
│
└───[👤]───`
tobi.sendMessage(from, menu4, MessageType.text, {quoted: ftoko})
break
...
│
└───[📥]───	`
tobi.sendMessage(from, menu3, MessageType.text, {quoted: ftoko})
break
